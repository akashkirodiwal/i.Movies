...
urlpatterns = [
    ...
    url(r'^screening/(?P<movie_title>.+)/$', mov_views.movie_selected, name='screening'),
    url(r'^booked/(?P<screen_pk>.+?)/$', mov_views.ticket_booked, name='finalbook'),
    path('payment_done/',mov_views.payment_status,name='payment_status'),
    url(r'^cancel/(?P<ticket_pk>.+?)/$', mov_views.cancel, name='cancel'),
    url(r'^done_cancellation/(?P<ticket_pk>.+?)/$', mov_views.done_cancellation, name='done_cancellation'),
